...
public class WMG_Axis_Graph : WMG_Graph_Manager {
	...
	public FontStyle TitleLabelFontStyle { get {return _TitleLabelFontStyle;} 
		set {
			if (_TitleLabelFontStyle != value) {
				_TitleLabelFontStyle = value;
				graphC.Changed();
			}
		}
	}
	...
	[SerializeField] private FontStyle _TitleLabelFontStyle;
